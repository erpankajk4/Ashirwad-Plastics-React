...
$recipientEmail='ashirwad@ashirwadplastics.com';
$recipientName='Ashirwad Plastics';

//collect the posted variables into local variables before calling $mail = new mailer

$senderName = $_POST['name'];
$senderPhone = $_POST['email'];
...
if(!$mail->Send()) {
	echo '<div class="" role="alert">Error: '. $mail->ErrorInfo.'</div>';
} else {
	echo '<div class="" role="alert">Thank you. We will contact you shortly.</div>';
}
?>